  ...
  function GuardarEspecialidad(e) {
    ...
    if (localizacionEspecialidad && nombreEspecialidad) {
      ...
      if (!editarAgregarLocacion) {
        ...
        inputCrearEspecialidad.nb_especialidad_test = nombreEspecialidad
          .toUpperCase()
          .normalize('NFD')
          .replace(/[\u0300-\u036f]/g, '')
        inputCrearEspecialidad.bl_restriccion_edad = restricEdad
        inputCrearEspecialidad.bl_edad_maxima_minima = maxMinEdad
        inputCrearEspecialidad.nu_edad = parseInt(edad) || 0
        inputCrearEspecialidad.bl_restriccion_sexo = restricSexo
        inputCrearEspecialidad.tx_sexo = sexo ? 'M' : 'F'
      }
      ...
      console.log(inputCrearEspecialidad)
        ...
        <div className="grid grid-cols-6 gap-4">
          ...
          {!editarAgregarLocacion && (
            <div className="field col-span-2">
              ...
              >
                <h1 className="mt-[3%] mr-[3%]">¿Requiere Orden?</h1>
                <ToggleButton
                  checked={ordenMedica}
          ...
          {!editarAgregarLocacion && restricEdad === true && (
            <div className="field col-span-2">
              <motion.span
                variants={animation(3)}
                initial="hidden"
          ...
          {!editarAgregarLocacion && restricSexo === true && (
            <div className="field col-span-2">
              <motion.span
                variants={animation(3)}
                initial="hidden"
