...
function TablaSolicitudCitas() {
  ...
  const [visibleEditEspecialidad, setVisibleEditEspecialidad] = useState(false)
  const [rowDataEditEspecialidad, setRowDataEditEspecialidad] = useState(null)
  const [
  ...
  function editEspecialidad(rowData){
    setVisibleEditEspecialidad(true)
    setRowDataEditEspecialidad(rowData)
  }
      ...
      <div>
        {permisos?.tx_permisos[2] && (
          <Button
            ...
            icon="pi pi-cog"
            className="p-button-rounded p-button-warning sm:mb-1 sm:ml-2"
        ...
        {permisos?.tx_permisos[2] && (
          <Button
            ...
            icon="pi pi-copy"
            className="p-button-rounded p-button-info ml-2 sm:mb-1"
        ...
        {permisos?.tx_permisos[1] && (
          <Button
            ...
            icon="pi pi-plus-circle"
            className="p-button-rounded p-button-help ml-2 sm:mb-1"
            tooltip="Agregar Locación"
          ></Button>
        )}
        {permisos?.tx_permisos[1] && (
          <Button
            onClick={() => editEspecialidad(rowData)}
            icon="pi pi-pencil"
            className="p-button-rounded p-button-warning ml-2 sm:mb-1"
  ...
  return (
    <AppLayoutMenus title="ESPECIALIDADES" items={items}>
      ...
      <EditarRestriccion
        visibled={visibleEditEspecialidad}
        setVisibled={setVisibleEditEspecialidad}
        tokenQuery={token}
        refresPac={mutate}
        rowDataEditar={rowDataEditEspecialidad}
        setRowDataEditar={setRowDataEditEspecialidad}
      />
